...
void hd44780_user_symbol (char adr, const char symbol[8]);  // Функция записи пользовательского символа 5х8: ADR - адрес ячейки CGRAM, SYMBOL - массив из 8 строк вида char SYMBOL[8]={
                                                // 0b000XXXXX,          
                                                // 0b000XXXXX,
                                                // 0b000XXXXX,
   //        ВАЖНО!!!                           // 0b000XXXXX,
